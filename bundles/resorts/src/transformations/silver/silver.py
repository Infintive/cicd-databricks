...
def resorts_silver():
	...
	return (
		...
		.withColumn("summit_elevation_ft", _elevation_feet("summit_elevation"))
		.withColumn("base_elevation_ft", _elevation_feet("base_elevation"))
		.withColumn("vertical_drop_ft", _numeric_from_text("vertical_drop", "int"))
		.withColumn("skiable_area_acres", _numeric_from_text("skiable_area", "double"))
		.withColumn("annual_snowfall_in", _numeric_from_text("annual_snowfall", "int"))
